/**
******************************************************************************
* @file    VL53L8CX_TableOutput_CM.ino
...
/* ========================================================================== */
/* Cetak hasil dalam format tabel 8x8 dan satuan cm                           */
/* ========================================================================== */
void print_result(VL53L8CX_ResultsData *Result)
{
  Serial.println("\n=============================");
  ...
  for (uint8_t y = 0; y < 8; y++) {
    for (uint8_t x = 0; x < 8; x++) {
      ...
      if (Result->nb_target_detected[index] > 0) {
        float distance_cm = Result->distance_mm[index] / 10.0; // konversi mm → cm
        Serial.print(distance_cm, 1);  // tampilkan 1 angka di belakang koma
        Serial.print("\t");            // tab antar kolom
      } else {
        Serial.print("X\t");           // tidak ada target
      }
    }
    Serial.println();
  }
...
/* Fungsi tambahan dari ST tetap dipertahankan */
